      ...
      body: FutureBuilder<List<Room>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView(
                children: [
                  NotificationText(text: Constants.noRoomsCreated)
                ]);
          }
        },
      ),
      floatingActionButton: AddButton(
        onPressed: () async {
              ...
              MaterialPageRoute(
                builder: (_) {
                  return ChangeNotifierProvider(
                    create: (_) => AddRoomViewModel(isEditing: false, roomService: widget.roomService),
            ...
            if (result == true && mounted) {
              setState(() {}); // Rebuilds the widget and triggers reload (e.g. in initState or build)
            }
          }
      ),
    );
